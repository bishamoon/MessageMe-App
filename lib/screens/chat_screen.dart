...
/*   void messagesStreams() async {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        backgroundColor: Color.fromARGB(255, 202, 186, 247),
        title: Row(
          children: [
            Image.asset(
        ...
        children: [
          ...
          Container(
            decoration: BoxDecoration(
              border: Border(
                top: BorderSide(
                  color: Color.fromARGB(255, 255, 171, 185),
                  width: 2,
                ),
              ),
            ),
        ...
        if (!snapshot.hasData) {
          return Center(
            child: CircularProgressIndicator(
                backgroundColor: Color.fromARGB(255, 255, 171, 185)),
          );
        }
      ...
      child: Column(
        ...
        children: [
          Text(
            '$sender',
            style: TextStyle(
                fontSize: 12, color: Color.fromARGB(255, 122, 99, 170)),
          ),
          Material(
            elevation: 5,
            borderRadius: isMe
                ...
                : BorderRadius.only(
                    ...
                    bottomRight: Radius.circular(30)),
            color: isMe
                ? Color.fromARGB(255, 149, 121, 209)
